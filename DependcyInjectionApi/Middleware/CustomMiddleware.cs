...
namespace DiApi.Middleware
{
    public class CustomMiddleware
    {
        ...
        public CustomMiddleware(RequestDelegate next, IOperationTransient transient,
        ...
        {
            System.Console.WriteLine($"Middleware: TransientId: {_transient.OperationId} ScopedId: {scoped.OperationId} Singleton {_singleton.OperationId}");
            await _next(context);
        }
    }
